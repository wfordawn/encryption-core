...
public class EmailUtils {
    ...
    //发件人邮箱授权码
    private final static String AUTHORIZATION_CODE = "BSRWLCENDIAREKSO";

    // 发件人  
    private static String from = "wfordawn@126.com";

    // 收件人  
    private static String to = "收件人邮箱";
     ...
     * 发送简单的html邮件
     */
    public static boolean sendHtmlEmail(String to, int code) {
        try {
            // 创建Session实例对象
            Session session = Session.getInstance(props, new MyAuthenticator());
            ...
            message.setContent("<div style='width: 600px;margin: 0 auto'>"
                            + "<h3 style='color:#003E64; text-align:center; '>内燃机注册验证码</h3>" + "<p style=''>尊敬的用户您好：</p>"
                            + "<p style='text-indent: 2em'>您在注册内燃机账号，此次的验证码是：" + code + ",有效期10分钟!如果过期请重新获取。</p>"
                            + "<p style='text-align: right; color:#003E64; font-size: 20px;'>中国内燃机学会</p>" + "</div>",
